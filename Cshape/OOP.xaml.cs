using Cshape.Classes;

namespace Cshape;

public partial class OOP : ContentPage //ตัวแปรที่อยู่ในปีกกาใหญ่ สามารถใช้ในปีกกาเล็กได้หมดเลย
{ 
	Car audi;
	Car nissan;
	bool isFinish = false;
	    ...
	    private void Button_Clicked(object sender, EventArgs e)
    {
		...
		{
			ImageCar1.TranslateTo(0,0,2000,Easing.Linear);
			ImageCar2.TranslateTo(0,0,2000,Easing.Linear);
			this.isFinish = false;
		}
		//audi.Run(10);
		//nissan.Run(5);
